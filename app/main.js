const creatForm = document.getElementById("form_post");
const message = document.querySelector(".message");
const showData = document.querySelector(".post-area-list");
      ...
      <div class="post-comments">
        <div class="comments-header">
          <div class="reaction">
            ...
            <a href="#">Johurul Islam & 50 Others Reacted</a>
          </div>
          <div class="counts">
...
creatForm.onsubmit = (e) => {
  ...
  if (!data.author_name || !data.author_photo) {
    message.innerHTML = createAlert("Author Name Cannot Be Empty");
  } else {
    //   Get Previous Data
